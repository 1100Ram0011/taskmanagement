...
import { useDuplicateMutation, useTrashTaskMutation } from "../../redux/slices/api/taskApiSlice";
...
const TaskDialog = ({ task }) => {
    ...
    const [deleteTask, { isLoading }] = useTrashTaskMutation();
    const [duplicateTask] = useDuplicateMutation();
