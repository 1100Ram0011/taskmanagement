...
// const TaskCard = ({ task }) => {
//   return (
//     <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200 w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto">
//       <h3 className="text-md font-medium mb-2">{task.title}</h3>
...
//       <div className="text-sm text-gray-600 mt-2 flex flex-col sm:flex-row sm:justify-between">
