        ...
        <>
            <div>
                <Menu as='div' className='relative inline-block text-left'>
                    <div>
                        <Menu.Button className='w-10 h-10 2xl:w-12 2xl:h-12 items-center justify-center rounded-full bg-red-700'>
            ...
            <AddUser setOpen={setOpen} open={open} userData={user} />
            <ChangePassword setOpen={setOpenPassword} open={openPassword}/>
        </>
    );
};
